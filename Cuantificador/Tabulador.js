...
const tipoAccidenteElement = document.getElementById('Tabulador.html');
if (clave) {
    switch (clave) {
        case '1':
            tipoAccidenteElement.textContent = 'SEÑAL CHAROLA RECTANGULAR, CON UN POSTE - 71 x 71 cm., Incluye poste.';
            break;
        case '2':
